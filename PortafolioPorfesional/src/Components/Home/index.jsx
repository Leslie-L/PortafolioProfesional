        ...
        <main id='AboutMe' className='w-full h-screen flex flex-col justify-center items-center md:flex-row'>
            <section className='mt-28'>
                ...
                <div className='w-72 flex justify-center gap-4 mt-4'>
                    <a href="https://github.com/Leslie-L"><FontAwesomeIcon className='w-8 h-8 hover:text-pink' icon={faGithub} /></a>
                    <a href=""><FontAwesomeIcon className='w-8 h-8 hover:text-pink' icon={faTwitter} /></a>
                    <a href=""><FontAwesomeIcon className='w-8 h-8 hover:text-pink' icon={faLinkedin} /></a>
                    <a href=""><FontAwesomeIcon className='w-8 h-8 hover:text-pink' icon={faEnvelope} /></a>
                </div>
            </section>
            <section className='font-size font-monserrat md:mt-28 md:ml-12 md:flex md:justify-center md:items-center'>
                <div>
                    <h2 className='text-xl font-regular'>{homeInfo.GREETING}</h2>
                    <h1 className='font-semibold text-orange text-xl'>{homeInfo.NAME}</h1>
                    <p  className='w-72 text-md font-light md:w-80 md:mt-4'>{homeInfo.INTRODUCE}</p>
                </div>
            </section>
        </main>
    )
